...
public interface PatientMonitoringFlowsheetService {
    ...
    FlowsheetAttribute getFlowsheetAttributesForPatientProgram(PatientProgram bahmniPatientProgram, PatientIdentifierType patientIdentifierType, OrderType orderType, Set<Concept> concepts);
